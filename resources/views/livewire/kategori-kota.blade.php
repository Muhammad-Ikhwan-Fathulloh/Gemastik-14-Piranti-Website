<div>
    ...
    <div>
      <form class="d-flex" wire:poll>
          <input wire:model="search" class="form-control me-2 border-light" type="text" name="search" placeholder="Cari Kategori Kota" aria-label="Search" value="">
...
<div wire:ignore.self class="modal fade" id="addkategori" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"><i class="fas fa-fw fa-map"></i> Tambah Kategori Wisata</h5>
  ...
  <div class="form-group">
    <label class="text-white" for="">Kategori Kota</label>
    <input type="text" name="kategori_wisata" wire:model="kategori_wisata" class="form-control" placeholder="Masukkan Kategori Kota">
...
<div wire:ignore.self class="modal fade" id="editkategori" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel"><i class="fas fa-fw fa-map"></i> Ubah Kategori Wisata</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close" wire:click.prevent="clearform()">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<div wire:ignore.self class="modal modal-danger fade" id="delete{{ $datas->id }}">
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-ku">
      <div class="modal-header">
        <h5 class="modal-title text-white" id="exampleModalLabel"><i class="fas fa-fw fa-map"></i> {{ $datas->kategori_wisata }}</h5>

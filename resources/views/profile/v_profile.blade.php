...
<div class="card border-light mb-3 bg-ku">
  <div class="card-header">
    <i class="fas fa-fw fa-barcode"></i> <strong>Scan QR Code Kartu</strong>
  </div>
  <div class="card-body">
    ...
    @csrf
      <div class="form-group">
          ...
          <input  type="text" name="uids" id="uids" class="form-control" placeholder="Scan UID Kartu">
          @error('uids') <div class="alert alert-danger">{{ $message }}</div> @enderror
      </div>
      <div class="form-group">
            <button class="btn btn-success btn-sm">Daftarkan Kartu</button>
          </div>
          </form>
           <hr>
      <div class="row">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content bg-ku">
      <div class="modal-header">
        <h5 class="modal-title text-white" id="exampleModalLabel"><i class="fas fa-fw fa-barcode"></i> Scan QR Code Kartu</h5>
